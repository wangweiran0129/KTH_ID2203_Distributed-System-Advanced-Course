...
(*--algorithm Paxos
 { variable AccMsg={}, PMsg={}; \* AccMsg: all Acceptor's receiving channel and PMsg: All Proposers' recv channel 
   ...
   LostLeadership(b) == Cardinality({m \in PMsg: m.bal > b}) >= (N-M+1) \div 2 + 1 (*** Check if leadership with the ballot b has been lost ***) 
   }
...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "bedec24d" /\ chksum(tla) = "12d661a2")
...
LostLeadership(b) == Cardinality({m \in PMsg: m.bal > b}) >= (N-M+1) \div 2 + 1
...
\* Last modified Sat May 15 14:54:50 CEST 2021 by wangweiran
