...
Validity == \A i \in decided: decided[i] \in PMsg
\* UC2 (Uniform Agreement) No two processes decide different values
Uniform_Agreement == \A pid1, pid2 \in decided: decided[pid1] = decided[pid2]
\* UC3 (Integrity) Each process can decide a value at most once
Integrity == \A pid \in decided: Cardinality(decided[pid]) = 1
\* UC4 (Termination) Every correct process eventually decides a value
Termination == <> (decided /= {})
=============================================================================
\* Modification History
\* Last modified Thu Mar 25 19:56:48 CET 2021 by wangweiran
